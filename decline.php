    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Declined Apllicants</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="card">
              <div class="card-body">
                <table class="table">
                  ...
                  <tbody>
                    <?php
                    $get_applicants = mysqli_query($conn, "SELECT * FROM applicants WHERE company_email='$e ' AND application_status = 'decline'");
