            ...
            <div class="card">
              <div class="card-body">
                <table class="table">
                  ...
                  <tbody>
                    <?php
                    $get_applicants = mysqli_query($conn, "SELECT * FROM applicants WHERE company_email='$e ' AND application_status = 'Pending'");
                    ...
                    ?>
                      <tr>
                        ...
                        <td> <a href="../student_dashboard/letter/<?php echo $applicants['application_letter'] ?>">View Application</a></td>
                        ...
                        <td><button type="submit" name="approved" class="btn btn-primary">Approved</button> </td>
